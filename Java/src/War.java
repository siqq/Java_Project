...
/**
 * @author Gal Karp AND Andrey Vachovski
 */
public class War {
     ...
     * @param enemy_launcher --> The launcher you want to add
     */
     ...
     * @param type --> Enter the type of the destroyer plain/ship
     ...
     * @param id --> The iron dome id user select
     ...
     * @param destination --> String, The destination of the missile
     * @param damage --> Integer, The Damage of the missile
     * @param flytime --> Integer, The flytime of the missile
     * @param launcher --> Enemy_Launcher, The launcher which will fire the missile
     */
    public void LaunchMissile(String destination, int damage, int flytime,
	    Enemy_Launcher launcher) throws InterruptedException {
	//Check if there are any launcher available or user should create new one
	if (launchers.size() == 0) {
     ...
     * @param destructTime --> String, the delay time for the interception
     * @param id --> String, The id of the launcher you want to destroy
     * @param launcherDestroyer --> Launcher destroyer, The destroyer that destroy the launcher
     */
     ...
     * @param destructAfterLaunch --> String, The time which the interception will occured
     * @param id --> String , The id of the enemy missile
     * @param ironDome --> Iron_Dome, the iron dome that will fire the interceptpr
     */
     ...
     * @param enemy_launcher --> Enemy_Launcher, the launcher the missile will be added to
     * @param missile --> Enemy missile, The missile that will be added
     */
     ...
     * @param launcherId --> String, the launcherId the will be checked
     */
     ...
     * @param destroyerId --> String, the destroyerId the will be checked
     */
	...
	for (Launcher_Destroyer launcher_destroyer : getWarLauncherDestroyer()) {
	    if (launcher_destroyer.getLauncherName().equalsIgnoreCase(
		    destroyerId)) {
	...
	if (user_destroyer != null) {
	    ...
	    System.out.println("Destroyer does not exist");
	    return null;
	}
    }
    //Getters and Setters
