...
public class readXml {
	...
	try {
	    // File file = new
	    // File("C:/Users/Andrey/git/Java_Project/Java/src/war2.xml");
	    File file = new File(
		    "C:/Users/DELL-PC/git/Java_Project/Java/src/war2.xml");
     ...
     * @param nodeList --> The element node that will be checked
     * @param war --> The war that running
     */
	...
	for (int count = 0; count < nodeList.getLength(); count++) {
		...
		if (tempNode.hasAttributes()) {
			...
			if (tempNode.getNodeName() == "launcher") {
				...
				//Check if destructor is iron dome or plane/ship
				ironDome = war.Create_Iron_Dome(nodeMap.item(i)
					.getNodeValue());
			    } else {
